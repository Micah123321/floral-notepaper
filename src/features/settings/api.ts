...
import type { AppConfig, SyncOverview, SyncStatus, ViewMode } from "./types";
...
export function checkWebdavStatus(): Promise<SyncOverview> {
  return invoke("sync_webdav_status");
}
